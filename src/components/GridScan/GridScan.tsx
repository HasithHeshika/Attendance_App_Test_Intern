'use client';
// face-api.js is imported lazily (only when `enableWebcam`) — it pulls in TensorFlow
// and is huge, so a static import would bloat the bundle and make any page using
// GridScan (e.g. the login screen, which runs with the webcam OFF) take ~90s to
// compile in dev and ship a massive chunk in prod.
